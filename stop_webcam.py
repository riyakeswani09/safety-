...
#         .create(
#             body=f'You were caught riding without helmet near {CAMERA_LOCATION}, and were fined Rupees 500. Please visit https:www.nshikrto.gov.in to pay your due challan. If you are caught riding again without proper gear, you will be severely penalized.',
#             from_='+19561702030',
#             to=f'+{number}'
#         )
...
def sendMail(mail):
    ...
    message["Subject"] = 'Notification Helmet e-challan fine'
    message["From"] = mail
    message["To"] = mail
    ...
    body = f'You were caught riding without helmet near {CAMERA_LOCATION}, and were fined Rupees 500. Please visit https:www.nashikrto.gov.in to pay your due challan. If you are caught riding again without proper gear, you will be severely penalized.'

    message.attach(MIMEText(body, "plain"))
    server.login('rto.maharashtra15@gmail.com', 'muki jsux jxir mmyp')
    server.sendmail('rto.maharashtra15@gmail.com', mail, message.as_string())
    server.quit()
        ...
        if licensePlate not in warnedNums:
            for index, plate in enumerate(database['Registration']):
                if licensePlate == plate:
                    ...
                    database.to_csv(r'D:\code\code\database.csv', index=False)